...
class BaseInfluencer(ABC):
    ...
    def __init__(self, username: str, followers: int, engagement_rate: float):
        ...
        self.campaigns_participated_in = []  #campaings as objects
